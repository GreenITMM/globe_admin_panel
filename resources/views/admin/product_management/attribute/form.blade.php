<form id="{{request()->is('admin/product-management/attributes/create') ? 'attribute_create_form' : 'attribute_edit_form'}}">
    @csrf
    <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
            <input type="hidden" name="attribute_id" id="attribute_id" value="{{isset($attribute) ? $attribute->id : null}}">
            <div class="form-group mb-4">
                <label for="">AttributeName <span class="text-danger">*</span></label>
                <input type="text" name="name" class="form-control name" placeholder="eg. Color, Size" value="{{ old('name', isset($attribute) ? $attribute->name : null) }}">
