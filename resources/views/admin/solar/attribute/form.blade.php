<form id="{{request()->is('admin/solar/solar-attributes/create') ? 'solar_attribute_create_form' : 'solar_attribute_edit_form'}}">
    @csrf
    <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
            <input type="hidden" name="solar_attribute_id" id="solar_attribute_id" value="{{isset($solarAttribute) ? $solarAttribute->id : null}}">
            <div class="form-group mb-4">
                <label for="">AttributeName <span class="text-danger">*</span></label>
                <input type="text" name="name" class="form-control name" placeholder="eg. Color, Size" value="{{ old('name', isset($solarAttribute) ? $solarAttribute->name : null) }}">
        ...
        <div class="col-lg-3 col-md-5 col-sm-12 col-12">
            <div class="form-group mb-4">
                ...
                <div class="attr-value-container" style="max-height: 500px; overflow-y: scroll;">
                    @if(isset($solarAttribute))
                        @foreach($solarAttribute->values as $value)
