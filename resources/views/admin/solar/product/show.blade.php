    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped" id="DataTable">
                <tr>
                    <th>Name</th>
                    <td>{{ $solarProduct->name }}</td>
                </tr>
                <tr>
                    <th>Category</th>
                    <td>{{ $solarProduct->category->name }}</td>
                </tr>
                <tr>
                    <th>Images</th>
                    <td>
                        <div class="d-flex flex-wrap gap-3">
                            @foreach ($solarProduct->images as $file)
                ...
                <tr>
                    <th>Description</th>
                    <td>{{ $solarProduct->description }}</td>
                </tr>
                <tr>
                    <th>Specification</th>
                    <td>{!! $solarProduct->specification !!}</td>
                </tr>
